...
- Ausdrucksstreben in der Musik des 16. und 17. Jahrhunderts:
  
  - Entwicklung musikalischer Mittel zur wirkungsvollen Darstellung von Affekten (z. B. Gemütszustände handelnder Personen in einer Oper)

- Erweiterte Vorstellung:
  
  - alle Musik diene dem Ausdruck von Affekten
...
- Wachsendes Interesse an vertonten Texten:
  
  - musikalische Ausdeutung wurde für zunehmend wichtiger gehalten

- Zuordnung musikalischer Mittel:
  
  - bestimmte musikalische Parameter schienen zu textlichen Anforderungen mehr oder minder genau zu 'passen'

- Musikalische Parameter:
  
  - Tonart, Tempo, Tongeschlecht, Takt und Rhythmus, Instrumentenwahl, Intervalle und Akkorde, Satzart etc.
...
- **Anwendung & Bewusstheit**
  ...
  - **Alternative Erklärung:** beim Komponieren einfach Nachahmung des Lehrers oder älterer Vorbilder
...
- **:** Folge abwärts führender Halbtonschritte, besonders im Bass
...
- Regelwidrige Dissonanzen:
  ...
  - Querstände (*relatio non harmonica*)
    
    <!--style="width:30%;"-->
    !["Querstand"](https://upload.wikimedia.org/wikipedia/commons/a/a9/Hinunter_ist.gif "Bild: Wikimedia")
...
- Noëma:
  ...
  - z. B. homophoner Teil in polyphonem Satz (Konsonanzen)
...
- Heutige Forschungsposition
  ...
  - Regionale Begrenzung: Figurenlehre scheint eine auf den protestantischen Raum Deutschlands beschränkte Angelegenheit gewesen zu sein.

## Heinrich Schütz

Es gibt einen eigenen Kurs zu @config.link.course(Schütz,schuetz_heinrich)
...
[[X]] *affectus exprimere*: Darstellung von Affekten
[[ ]] *musica speculativa*: theoretische Durchdringung der Musik
[[X]] *affectus movere*: Auslösung von Affekten bei den Zuhörern
...
**Erläutern Sie die Entwicklung und Bedeutung der musikalischen Figurenlehre im 17. und 18. Jahrhundert.**
